...
begin
	using PlutoUI
	@bind yr0 Slider(1929:1:2025, default=1929, show_value=true)
	@bind yr1 Slider(1929:1:2025, default=1925, show_value=true)
end
...
md"""
**Table X.1: GDP and GDI, 2024 (\$ Billions)**
"""
...
md"# Plotting Components of GDP

Table X.1 reports gross domestic product and income for only one year. Next, we use a Julia code to plot these series over time using a csv loaded from the Data Center. We can use the sliders to pick starting and ending years.


# ╔═╡ b5555555-5555-5555-5555-555555555555
md"Choose the starting year yr0 (default value = 1929)
"

# ╔═╡ b6666666-6666-6666-6666-666666666666
md"Choose the ending year yr1 (default value = 1925)
"

# ╔═╡ b7777777-7777-7777-7777-777777777777
# Load NIPA data
begin
   raw         = readdlm("../DATA/nipa.dat", Any) 
...
# ╔═╡ ef59cf00-b875-46d9-9f16-d6d022b107f6
html"""
<script>
...
manifest_format = "2.0"
project_hash = "4b90ba991837e4771a5ab53fd279cff07785d9a9"
...
# ╠═bf8098a6-fcd7-4146-adc8-13d2d279e3ae
# ╠═5998d81c-245a-468b-adb3-1a5378c5aa3d
# ╟─ece07c81-6a9c-4f2a-a942-cd6fd72af943
# ╠═178c9d53-940f-46c0-923c-1e18e34647c6
# ╠═68a03dde-ca70-43de-84ac-3c00150ac16d
# ╟─604696ee-a7f5-49fb-b70e-01850ae9873c
# ╠═52b49bfc-9258-4a29-bcd1-d93fb65cc549
# ╠═3adda442-1bd7-4047-b216-2a27583bb1b9
# ╟─d729260f-ef2a-4198-b14b-b5b25289a337
# ╟─1b07622a-4312-4e2e-afed-08a7c23c351f
