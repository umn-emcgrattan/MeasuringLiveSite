...
# Required packages
using DelimitedFiles, Measures, Plots, PlutoUI

# ╔═╡ 22222222-2222-4222-8222-222222222222
md"""
# GDP and GDI

This notebook reads a CSV file containing `Year`, `GDP`, and `GDI`, and plots
the two measures of aggregate output.
"""

# ╔═╡ 33333333-3333-4333-8333-333333333333
begin
    datafile = joinpath(@__DIR__, "gdp_gdi.csv")

    raw, header = readdlm(datafile, ',', header=true)

    column_names = vec(String.(header))
    required_names = ["Year", "GDP", "GDI"]

    column_names == required_names ||
        error("Expected CSV columns Year,GDP,GDI but found $(join(column_names, ","))")
...
manifest_format = "2.0"
project_hash = "ee167f717b0fa908ec27755cc5440b720f519681"
